const I18N = {
  en: {
    ...
    tip_doctor: "flyflor doctor --fix",
    tip_pairing: "flyflor pairing list",
    tip_cron: "flyflor cron list --all",
    empty: "(empty)",
    none: "none",
    unknown: "unknown",
    no_name: "(no name)",
    ...
    hint_run_doctor_fix: "Run `flyflor doctor --fix`.",
  ...
  zh: {
    ...
    hint_run_doctor_fix: "运行 `flyflor doctor --fix`。",
...
function mapHealthHint(hint) {
  ...
  if (hint === "Run `flyflor doctor --fix`.") {
