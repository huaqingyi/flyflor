...
var (
	...
	accentCyan   = lipgloss.Color("#18A0A0")
	accentGold   = lipgloss.Color("#B7791F")
	accentPink   = lipgloss.Color("#F06292")
	accentLime   = lipgloss.Color("#A3E635")
	accentViolet = lipgloss.Color("#A78BFA")
	accentOrange = lipgloss.Color("#FB923C")
