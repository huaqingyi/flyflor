...
func completeMCPServerNames(_ *cobra.Command, args []string, _ string) ([]string, cobra.ShellCompDirective) {
	if len(args) > 0 {
	...
	return sortedServerNames(cfg.Tools.MCP.Servers), cobra.ShellCompDirectiveNoFileComp
}
