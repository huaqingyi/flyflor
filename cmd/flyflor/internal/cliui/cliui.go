...
var (
	accentBlue   = lipgloss.Color("#8B5CF6")
	accentRed    = lipgloss.Color("#FB7185")
	accentCyan   = lipgloss.Color("#D946EF")
	accentGold   = lipgloss.Color("#F0ABFC")
	accentPink   = lipgloss.Color("#FF5FA2")
	accentLime   = lipgloss.Color("#C084FC")
	accentViolet = lipgloss.Color("#A855F7")
	accentOrange = lipgloss.Color("#E879F9")
	colorMuted   = lipgloss.Color("#8A7A99")
	colorOK      = lipgloss.Color("#C084FC")
)
...
// helpIntroStyle is the top tagline (Flyflor blue, matches ASCII banner left side).
...
func subtleBorderStyle() lipgloss.Style {
	return lipgloss.NewStyle().
...
func panelTitleStyle(color lipgloss.Color) lipgloss.Style {
...
func progressBar(percent int, width int) string {
	...
	colors := []lipgloss.Color{accentCyan, accentCyan, accentViolet, accentGold}
