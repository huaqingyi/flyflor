...
// Client credentials must be provided by environment variables; never commit
// Google OAuth client credentials to source control.
func GoogleAntigravityOAuthConfig() OAuthProviderConfig {
	return OAuthProviderConfig{
		Issuer:       "https://accounts.google.com/o/oauth2/v2",
		TokenURL:     "https://oauth2.googleapis.com/token",
		ClientID:     firstNonEmptyEnv("FLYFLOR_GOOGLE_ANTIGRAVITY_CLIENT_ID", "GOOGLE_ANTIGRAVITY_CLIENT_ID"),
		ClientSecret: firstNonEmptyEnv("FLYFLOR_GOOGLE_ANTIGRAVITY_CLIENT_SECRET", "GOOGLE_ANTIGRAVITY_CLIENT_SECRET"),
