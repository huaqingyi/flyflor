...
For the latest documentation, visit [docs.flyflor.local](https://docs.flyflor.local/docs/latest/getting-started/flyflor-overview).
...
| Chat apps | [`chat-apps.md`](./chat-apps.md) | Connect flyflor to Telegram, Discord, WeChat, and more |
| Agent social network | [`agent-social-network.md`](./agent-social-network.md) | Join external agent communities from flyflor |
...
| Topic | Repo docs | What it covers |
|---|---|---|
| Memory | [`memory.md`](./memory.md) | How flyflor stores, consolidates, and restores memory |
| Python SDK | [`python-sdk.md`](./python-sdk.md) | Use flyflor programmatically from Python |
