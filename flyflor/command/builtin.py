...
from flyflor import __version__
from flyflor.bus.events import OutboundMessage
from flyflor.command.router import CommandContext, CommandRouter
from flyflor.utils.helpers import build_status_content
from flyflor.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "flyflor"] + sys.argv[1:])
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    with suppress(Exception):
        from flyflor.utils.searchusage import fetch_search_usage
