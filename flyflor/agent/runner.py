...
from flyflor.agent.tools.ask import AskUserInterrupt
...
from flyflor.utils.helpers import (
...
from flyflor.utils.runtime import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set FLYFLOR_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("FLYFLOR_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
