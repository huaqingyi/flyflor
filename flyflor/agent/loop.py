...
from flyflor.agent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
from flyflor.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from flyflor.agent.tools.image_generation import ImageGenerationTool
from flyflor.agent.tools.message import MessageTool
from flyflor.agent.tools.notebook import NotebookEditTool
from flyflor.agent.tools.registry import ToolRegistry
from flyflor.agent.tools.search import GlobTool, GrepTool
from flyflor.agent.tools.self import MyTool
from flyflor.agent.tools.shell import ExecTool
from flyflor.agent.tools.spawn import SpawnTool
from flyflor.agent.tools.web import WebFetchTool, WebSearchTool
from flyflor.bus.events import InboundMessage, OutboundMessage
from flyflor.bus.queue import MessageBus
from flyflor.command import CommandContext, CommandRouter, register_builtin_commands
from flyflor.config.schema import AgentDefaults, BlackboardConfig
from flyflor.providers.base import LLMProvider
from flyflor.providers.factory import ProviderSnapshot
from flyflor.session.manager import Session, SessionManager
from flyflor.utils.artifacts import generated_image_paths_from_messages
from flyflor.utils.document import extract_documents
from flyflor.utils.helpers import image_placeholder_text
from flyflor.utils.helpers import truncate_text as truncate_text_fn
from flyflor.utils.image_generation_intent import image_generation_prompt
from flyflor.utils.progress_events import (
    build_tool_event_finish_payloads,
    build_tool_event_start_payload,
    invoke_on_progress,
    on_progress_accepts_tool_events,
)
from flyflor.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE
from flyflor.utils.webui_titles import mark_webui_session, maybe_generate_webui_title_after_turn

if TYPE_CHECKING:
    from flyflor.config.schema import (
        ChannelsConfig,
        ExecToolConfig,
        ProviderConfig,
        ToolsConfig,
...
class AgentLoop:
    ...
    def __init__(
        ...
        from flyflor.config.schema import ExecToolConfig, ToolsConfig, WebToolsConfig
        ...
        self.blackboard_config = blackboard_config or BlackboardConfig()

        self.context = ContextBuilder(
            workspace,
            timezone=timezone,
            disabled_skills=disabled_skills,
            blackboard_enabled=self.blackboard_config.enabled,
            blackboard_mode=self.blackboard_config.mode,
            blackboard_show_discussion=self.blackboard_config.show_discussion,
        )
        ...
        # FLYFLOR_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("FLYFLOR_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from flyflor.agent.tools.mcp import connect_mcp_servers
    ...
    def _tool_hint(self, tool_calls: list) -> str:
        ...
        from flyflor.utils.tool_hints import format_tool_hints
