"""MCP client: connects to MCP servers and wraps their tools as native flyflor tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a flyflor Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only flyflor Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only flyflor Tool."""
