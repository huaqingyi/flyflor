...
This directory contains built-in skills that extend flyflor's capabilities.
...
When skills reference large local documentation or logs, prefer flyflor's built-in
