...
export function ChatComposer({
  ...
  return (
    <div className="before:bg-background/90 pointer-events-none relative z-10 mt-0 shrink-0 overflow-y-auto px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] [scrollbar-gutter:stable] before:pointer-events-none before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:content-[''] md:-mt-[24px] md:px-8 md:pb-8 md:before:top-[24px] lg:px-10 xl:px-12">
      <div className="bg-card/95 border-border/70 pointer-events-auto relative mx-auto flex max-w-[920px] flex-col rounded-lg border p-3 shadow-sm">
                ...
                <TooltipTrigger asChild>
                  <span tabIndex={!canSend ? 0 : undefined}>
                    <Button
                      type="button"
                      size="icon"
                      className="size-8 rounded-md bg-cyan-600 text-white transition-transform hover:bg-cyan-700 active:scale-95"
                      onClick={onSend}
                      disabled={!canSend}
