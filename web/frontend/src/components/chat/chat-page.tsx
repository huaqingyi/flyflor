...
import { BlackboardPanel } from "@/components/chat/blackboard-panel"
import {
  ChatComposer,
...
export function ChatPage() {
  ...
  return (
    <div className="from-background via-background to-muted/40 flex h-full flex-col bg-linear-to-br">
      <PageHeader
      ...
      <div className="border-border/60 bg-background/70 mx-3 mb-3 grid min-h-0 flex-1 grid-cols-1 overflow-hidden rounded-lg border shadow-sm lg:grid-cols-[minmax(0,1fr)_400px] 2xl:grid-cols-[minmax(0,1fr)_460px]">
        <section className="flex min-h-[560px] shrink-0 flex-col lg:min-h-0 lg:flex-1 lg:shrink">
          <div
            ref={scrollRef}
            onScroll={handleScroll}
            className="min-h-0 flex-1 overflow-y-auto px-4 py-6 [scrollbar-gutter:stable] md:px-8 lg:px-10 xl:px-12"
          >
            <div className="mx-auto flex w-full max-w-260 flex-col gap-6 pb-8">
        ...
        <aside className="border-border/60 hidden min-h-0 border-l bg-background/60 p-3 lg:block">
          <BlackboardPanel
